...
from ybor_technologies.big_rooster.py_rest.service.persistence.repositories.py_rest_repository import PyRestRepository  
...
from ybor_technologies.big_rooster.py_rest.service.persistence.entities.py_rest_entity import PyRestEntity
...
async def example_repository(db_session):
    """Create a real PyRestRepository for testing."""
    return PyRestRepository(db_session)
