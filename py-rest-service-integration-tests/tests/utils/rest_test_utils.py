...
def create_test_py_rest(name: str = "Test PyRest", **kwargs) -> Dict[str, Any]:
    """Create test py_rest data.
    
    Args:
        name: Name for the test py_rest
        **kwargs: Additional fields
        
    Returns:
        Dictionary with py_rest data
    """
    data = {
        "name": name,
...
def validate_py_rest_response(response_data: Dict[str, Any], expected_name: str = None):
    """Validate py_rest response data.
