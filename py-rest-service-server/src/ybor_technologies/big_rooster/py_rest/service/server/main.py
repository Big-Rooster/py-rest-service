"""
PyRestService Server Main

This module provides the main entry point for running the PyRestService
...
async def run_server(
    ...
    logger.info(f"Starting PyRestService server on {host}:{port}")
    ...
    try:
        ...
        logger.info("PyRestService server stopped")
...
def main() -> None:
    ...
    logger.info("PyRestService Server starting...")
