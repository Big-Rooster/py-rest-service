"""
Configuration management for PyRestService API
...
class Settings(BaseSettings):
    ...
    # API Configuration
    api_title: str = Field(
        default="PyRestService REST API",
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/py_rest_service",
