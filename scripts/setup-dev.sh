...
MODULES=(
    ...
    "py-rest-service-integration-tests"
)
...
import sys
sys.path.insert(0, '../py-rest-service-api/src')
try:
    import ybor_technologies.big_rooster.py_rest.service.api.models
...
if docker build -t py-rest-service:dev-test . >/dev/null 2>&1; then
    echo "   ✅ Docker build test passed"
    docker rmi py-rest-service:dev-test >/dev/null 2>&1 || true
else
