...
export PYTHONPATH="py-rest-service-server/src:py-rest-service-api/src:py-rest-service-core/src:py-rest-service-persistence/src"
...
exec uv run python -m ybor_technologies.big_rooster.py_rest_service.server.main --ephemeral "$@"