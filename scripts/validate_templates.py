...
class TemplateValidator:
    ...
    def __init__(self, template_dir: Path, reference_dir: Path = None):
        ...
        self.hardcoded_patterns = {
            ...
            r'python-rest01-service(?!-)': 'Service name should use py-rest-service',
            r'python-rest01-service-([a-z-]+)': 'Package name should use py-rest-service-$1',
            r'python_rest01_service': 'Python package should use py_rest_service',
            
            # Database patterns (excluding template variables and false positives)
            r'(?<!prefix_name }}_\{\{ suffix_name }})example_service(?!_core|_api|Service|Client|Impl)': 'Database name should use py_rest_service',
            
            # Import path patterns  
            r'from ybor\.playground\.python_rest01\.service': 'Import should use ybor_technologies.big_rooster.py_rest.service',
            r'import ybor\.playground\.python_rest01\.service': 'Import should use ybor_technologies.big_rooster.py_rest.service',
            r'-m ybor\.playground\.python_rest01\.service': 'Module path should use ybor_technologies.big_rooster.py_rest.service',
            
            # Docker and container patterns
            r'python-rest01-service(?=:)': 'Container name should use py-rest-service',
            r'python-rest01-service-postgres': 'Container name should use py-rest-service-postgres',
            r'python-rest01-service-prometheus': 'Container name should use py-rest-service-prometheus',
            r'python-rest01-service-grafana': 'Container name should use py-rest-service-grafana',
            
            # GitHub Actions workflow patterns
            r'Python REST Service(?! Integration)': 'Workflow name should use py-rest-service REST Service',
            
            # Configuration and title patterns
            r'"Python REST Service"': 'Title should use "py-rest-service REST Service"',
            r"'Python REST Service'": 'Title should use "py-rest-service REST Service"',
        }
    ...
    def _generate_fix_suggestion(self, pattern: str, line: str, match: re.Match) -> str:
        ...
        fixes = {
            'python-rest01-service': 'py-rest-service',
            'python_rest01_service': 'py_rest_service',
            'example_service': 'py_rest_service',
            'ybor.playground.python_rest01.service': 'ybor_technologies.big_rooster.py_rest.service',
            'Python REST Service': 'py-rest-service REST Service',
        }
